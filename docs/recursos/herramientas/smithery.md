...
# O con el wrapper apt:
apt install @smithery/cli
```

En i-HakLab, `pkg2conf` parchea automáticamente `process.platform` para Android y el shebang.
...
-   **OAuth:** Los MCP servers alojados en Smithery utilizan OAuth2. El endpoint unificado maneja esto automáticamente.
