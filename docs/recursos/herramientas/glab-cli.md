...
apt install glab-cli
# O mediante el gestor de paquetes oficial de GitLab:
# brew install glab  (macOS/Linux)
# Descarga el binario desde https://gitlab.com/gitlab-org/cli
```
...
-   **Token de acceso:** Necesitas un [Personal Access Token](https://gitlab.com/-/user_settings/personal_access_tokens) de GitLab con los scopes adecuados (`api`, `read_repository`, `write_repository`).
